                ...
                <div className="text d-flex align-items-center h-center">
                    <div>
                        <p>
                            ...
                            <a href="https://www.crmonline.com.au/">CRM Online Australia</a> building
                            solutions for the SugarCRM platform and implementing features for mobile
                            applications built using Ionic and Capacitor and portal features built in React.
                        </p>
                        <p>
